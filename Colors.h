...
/* Цвета основного меню */
#define C_BOX			D3DCOLOR_ARGB(255, 000, 000, 000)     //в нутри
#define C_BORDER		D3DCOLOR_ARGB(255, 238, 201, 000)     //огранка
#define C_TITL			D3DCOLOR_ARGB(255, 160, 32 ,240)     //Титлы

/* Цвета для кнопок основного меню */
#define C_BUT_ON          D3DCOLOR_ARGB(250, 0, 255, 127)  // текст  при включенной кнопке
#define C_BUT_OFF         D3DCOLOR_ARGB(255, 152, 245, 255)//текст  при выключенной кнопке

#define C_BUT_St          DarkRed  //фон кнопки - Начальный цвет
#define C_BUT_End         D3DCOLOR_ARGB(255, 000, 000, 000)    //фон кнопки - Конечный  цвет
#define C_BUT_BORDER		  D3DCOLOR_ARGB(255, 238, 201, 000)     //огранка
#define C_BUT_text_On		  line_Color                         // текст во включенном состоянии
#define C_BUT_text_OFF		  D3DCOLOR_ARGB(255,128,128,128)  // текст в выключенном состоянии
#define C_BUT_text_In		  D3DCOLOR_ARGB(255, 000, 255, 000)  // текст при наводке


/* Цвета суб-меню */
#define C_sub_BOX			D3DCOLOR_ARGB(255, 000, 000, 000)     //в нутри
#define C_sub_BORDER		D3DCOLOR_ARGB(255, 238, 201, 000)     //огранка

/* Цвета контролов */
#define C_Fon_Ctrl          0xff305C5F //фон
#define C_Bord_Ctrl          line_Color //обводка
#define C_Text_Ctrl          line_Color //текст
#define C_Text_Ctrl_in       D3DCOLOR_ARGB(255, 000, 255, 000) //текст при наводке

#define C_Check_St          DarkRed  //фон активного чекБокса - Начальный цвет
#define C_Check_End         D3DCOLOR_ARGB(255, 000, 000, 000)    //фон активного чекБокса  - Конечный  цвет
